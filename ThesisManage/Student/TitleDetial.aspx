...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="1" bordercolor="#2e90b0" style="width: 495px; font-family: 楷体_GB2312">
        ...
        <tr>
            <td align="right" style="width: 762px; height: 22px" valign="top">已选数量</td>
            <td style="width: 746px; height: 22px">
                <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
            <td align="right" style="width: 762px" valign="top">&nbsp;<asp:Label ID="Label5" runat="server" Text="指导老师:"></asp:Label></td>
            <td style="width: 746px">
                <asp:Label ID="Label6" runat="server" BorderStyle="None"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 762px; height: 28px" valign="top"></td>
