        ...
        <tr>
            ...
            <td align="left" style="width: 580px">
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtNewPassWord"
                    ControlToValidate="txtReNewPassWord" ErrorMessage="CompareValidator" Style="position: absolute" Width="190px">两次输入的密码不一样</asp:CompareValidator>
            </td>
        </tr>
        <tr>
            ...
            <td align="left" style="width: 580px">
                ...
                &nbsp;&nbsp; &nbsp;<asp:Button ID="btnEsc" runat="server" Text="退出" OnClick="btnEsc_Click" /></td>
        </tr>
    </table>
</asp:Content>
