    ...
    <table border="1" bordercolor="#2e90b0" style="width: 713px; font-family: 楷体_GB2312">
            ...
            <td style="width: 597px; height: 22px">
                <div align="left">
                    发送人:<asp:Label ID="Label1" runat="server" Font-Size="Small"></asp:Label>[<asp:Label
                        ID="Label2" runat="server" Font-Bold="True" Font-Size="Small"></asp:Label>]
                </div>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td style="width: 597px" valign="top">内&nbsp; 容:<br />
        ...
        <tr style="font-size: 12pt">
            <td style="width: 597px">
                <div align="right">
                    <asp:Label ID="Label4" runat="server" Font-Size="Small" Width="262px"></asp:Label>&nbsp;
                </div>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td style="width: 597px; height: 22px"></td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="left" style="width: 597px; height: 22px">回复:</td>
        </tr>
        <tr style="font-size: 12pt">
            <td style="width: 597px; height: 22px">收件人:<asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" Text="Label"
                Width="78px"></asp:Label></td>
        </tr>
        <tr style="font-size: 12pt">
            <td style="width: 597px; height: 22px" valign="top">内 容:<br />
