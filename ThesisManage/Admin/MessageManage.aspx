    ...
    <table border="1" bordercolor="#2e90b0" style="width: 631px; font-family: 楷体_GB2312">
        ...
        <tr>
            <td style="width: 503px" valign="top">角色:<asp:RadioButton ID="RadioButton3" runat="server" AutoPostBack="True" GroupName="btn"
                OnCheckedChanged="RadioButton3_CheckedChanged" Text="系统消息" />
                <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" GroupName="btn"
                    OnCheckedChanged="RadioButton1_CheckedChanged" Text="教师" />&nbsp;<asp:RadioButton
                        ...
                        Text="学生" /><br />
                接受人:<asp:TextBox ID="TextBox5" runat="server" Width="177px"></asp:TextBox>(注：用户名)<asp:Button
                    ID="Button3" runat="server" OnClick="Button3_Click" Text="查看联系人" /><br />
                <asp:Label ID="Label7" runat="server" Text="教员" Visible="False"></asp:Label><br />
                <asp:DataList ID="DataList1" runat="server" DataKeyField="TEID" OnItemCommand="DataList1_ItemCommand"
                    RepeatDirection="Horizontal" Visible="False" RepeatColumns="10">
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" Height="50px" ImageUrl='<%# GetImageUrl(Eval("TEID")) %>'
                            Width="40px" /><br />
                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("TeacherName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:DataList><asp:Label ID="Label6" runat="server" Font-Size="Small" ForeColor="Red" Visible="False"></asp:Label></td>
        </tr>
        <tr>
