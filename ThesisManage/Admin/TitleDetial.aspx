...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="1" bordercolor="#2e90b0" style="width: 495px; font-family: 楷体_GB2312">
        ...
        <tr>
            <td align="right" style="width: 6780px; height: 22px" valign="top">状态:</td>
            <td style="width: 746px; height: 22px">
                <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
            <td align="right" style="width: 6780px" valign="top">&nbsp;<asp:Label ID="Label5" runat="server" Text="指导老师:"></asp:Label></td>
            <td style="width: 746px">
        ...
        <tr>
            <td align="right" style="width: 6780px; height: 28px" valign="top">审核:</td>
            <td style="width: 746px; height: 28px">
                ...
                <asp:Panel ID="Panel1" runat="server" Height="50px" Width="125px" Visible="False">
                    <table style="width: 206px">
                        <tr>
                            <td align="center" colspan="3">请写明原因</td>
                        </tr>
                        <tr>
        ...
        <tr>
            <td align="right" style="width: 6780px; height: 28px" valign="top"></td>
            <td style="width: 746px; height: 28px"></td>
        </tr>
    </table>
</asp:Content>
