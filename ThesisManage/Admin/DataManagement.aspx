...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="1" cellpadding="1" cellspacing="1" bordercolor="#3366FF" style="width: 668px; font-family: 楷体_GB2312">
        <tr>
            <td bgcolor="#66CCFF" colspan="2" style="height: 22px; text-align: center;">添加数据
            </td>
        </tr>
        <tr>
            <td style="width: 16px">单行<br />
                添加
            </td>
            <td style="width: 352px">
                <table border="1" cellpadding="0" cellspacing="0" bordercolor="#2e90b0" style="font-family: 楷体_GB2312; width: 525px;">
                    <tr>
                        <td style="width: 646px; height: 26px">角色:<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="odsrole"
                        ...
                        <td style="width: 646px">
                            <asp:Panel ID="Panel1" runat="server" Height="150px" Width="640px">
                                <table border="1" cellpadding="0" cellspacing="0" bordercolor="#2e90b0" style="width: 595px; font-family: 楷体_GB2312">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 104px">班级:</td>
                            ...
                            <asp:Panel ID="Panel2" runat="server" Height="150px" Width="640px">
                                <table border="1" cellpadding="0" cellspacing="0" bordercolor="#2e90b0" style="width: 596px; font-family: 楷体_GB2312">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 106px">教师号:</td>
                                        <td align="left" style="width: 202px">&nbsp;<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4"
                                                ErrorMessage="*" Style="position: absolute"></asp:RequiredFieldValidator>
                                        </td>
                                        <td align="right" style="width: 71px">姓名:</td>
                                        <td align="left" style="width: 259px">&nbsp;<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
                            ...
                            <asp:Panel ID="Panel3" runat="server" Height="150px" Width="640px">
                                <table border="1" cellpadding="0" cellspacing="0" bordercolor="#2e90b0" style="width: 596px; font-family: 楷体_GB2312">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 106px">帐号:</td>
                                        <td align="left" style="width: 202px">&nbsp;<asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
        ...
        <tr>
            <td style="width: 16px; height: 66px;">多行<br />
                添加</td>
